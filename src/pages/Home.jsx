const Home = () => {
    return (
        <main>
            ...
            <section id="home" className="slider-area fix p-relative">
                <div className="slider-active2">
                    <div
                        ...
                        style={{ backgroundImage: "url(assets/img/an-bg/header-bg.png)" }}
                    >
                        <div className="container">
                            <div className="row align-items-center">
                                <div className="col-lg-6">
                                    <div className="slider-content s-slider-content text-left">
                                        ...
                                        <p data-animation="fadeInUp" data-delay=".6s">
                                            Quisque leo augue, lobortis ac tellus nec, posuere ultricies
                                            nulla. Praesent massa odio, pellentesque in consectetur quis,
                                            volutpat sit amet erat.
                                        </p>
                                ...
                                <div className="col-lg-6">
                                    <img
                                        src="assets/img/bg/header-img.png"
                                        alt="header-img"
                                    ...
                                    <li>
                                        <div className="slider-btn">
                                            <a
                                                ...
                                                data-delay=".8s"
                                            >
                                                Submit Now <i className="fas fa-chevron-right" />
                                            </a>
                                        </div>
                                    </li>
                                </ul>
            ...
            <section
                id="services"
                className="services-area services-bg services-two pt-100"
                style={{
                    backgroundImage: "url(assets/img/an-bg/an-bg02.png)",
            ...
            <section
                id="about"
                className="about-area about-p pt-65 pb-80 p-relative"
                style={{
            ...
            {/* department-area */}
            <section
                className="department-area cta-bg pb-70 mt-10 fix"
                style={{
            ...
            <section
                ...
                className="pb-20"
                style={{
                    backgroundImage: "url(assets/img/an-bg/an-bg13.png)",
                    backgroundSize: "contain",
                    backgroundPosition: "center center",
                    backgroundRepeat: "no-repeat"
                }}
                    ...
                    <div className="row team-active">
                        <div className="col-xl-4">
                            <div className="single-team mb-30">
                                ...
                                <div className="team-info">
                                    <h4>
                                        <a href="team-details.html">Samanta Crane</a>
                                    </h4>
                        ...
                        <div className="col-xl-4">
                            <div className="single-team mb-30">
                                ...
                                <div className="team-info">
                                    <h4>
                                        <a href="team-details.html">Ostin Green</a>
                                    </h4>
                                    <span>Internist, General Practitoner</span>
                                    <p>Working Since 2004</p>
                                </div>
                        ...
                        <div className="col-xl-4">
                            <div className="single-team mb-30">
                                ...
                                <div className="team-info">
                                    <h4>
                                        <a href="team-details.html">Norman Colins</a>
                                    </h4>
            ...
            <section
                id="pricing"
                className="pricing-area pb-70"
                style={{
                    backgroundImage: "url(assets/img/an-bg/an-bg08.png)",
                    backgroundPosition: "center",
                    backgroundRepeat: "no-repeat"
                }}
            >
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="pricing-box text-center mb-60">
                                <div className="pricing-head">
                                    ...
                                    <img src="assets/img/icon/pr-icon01.png" alt="pricon" />
                                </div>
                                ...
                                <div className="pricing-btn">
                                    <a href="#" className="btn">
                                        Choose Plan <i className="fas fa-chevron-right" />
                                    </a>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-12">
                            <div className="pricing-box active text-center mb-60">
                                <div className="pricing-head">
                                    ...
                                    <img src="assets/img/icon/pr-icon02.png" alt="pricon" />
                                </div>
                                <div className="pricing-body mb-40 text-left">
                                    <p>
                                        It is a long established fact that a reader will be distracted.
                        ...
                        <div className="col-lg-4 col-md-12">
                            <div className="pricing-box text-center mb-60">
                                <div className="pricing-head">
                                    ...
                                    <img src="assets/img/icon/pr-icon03.png" alt="pricon" />
                                </div>
                                <div className="pricing-body mb-40 text-left">
                                    <p>
                                        It is a long established fact that a reader will be distracted.
            ...
            {/* counter-area */}
            <div
                className="call-area pb-50"
                style={{
                    backgroundImage: "url(assets/img/an-bg/an-bg09.png)",
                    backgroundRepeat: "no-repeat",
                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5 col-md-12 col-sm-12">
                            <div className="single-counter-img fadeInUp animated">
                                <img src="assets/img/bg/ap-illustration.png" alt="img" className="img" />
                            </div>
                        </div>
                        <div className="col-lg-5 col-md-12 col-sm-12">
                        ...
                        <div className="col-lg-2 col-md-12 col-sm-12">
                            <div className="slider-btn mt-130">
                                <a
                                    ...
                                    data-delay=".8s"
                                >
                                    Appointment <i className="fas fa-chevron-right" />
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <section
                id="blog"
                className="blog-area  p-relative pt-100 pb-90 fix"
                style={{
                    backgroundImage: "url(assets/img/an-bg/an-bg10.png)",
                    backgroundSize: "contain",
                    backgroundRepeat: "no-repeat",
                    backgroundPosition: "center center"
                }}
                            ...
                            <div className="single-post mb-30">
                                <div className="blog-thumb">
                                    <a href="blog-details.html">
                                        ...
                                        <img src="assets/img/bg/b-link.png" alt="b-link" className="b-link" />
                                    </a>
                                </div>
                                    ...
                                    <div className="b-meta mb-20">
                                        <div className="row">
                                            <div className="col-lg-6 col-md-6">
                                                <i className="far fa-calendar-alt" /> 7 March, 2019
                                            </div>
                                            <div className="col-lg-6 col-md-6">
                                                <i className="fas fa-user" /> By Jhone Doe
                                            </div>
                                        </div>
                                    </div>
                                    <h4>
            ...
            <section
                id="contact"
                className="contact-area contact-bg pb-70 p-relative fix"
                style={{
